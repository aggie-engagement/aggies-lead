...
export function CampusNavigationWhoClient() {
  ...
  const nextHref = nextFreshmanModuleHref("campus-navigation-who-you-should-know");
      ...
      <section className="card-surface rounded-lg p-6">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="flex flex-col gap-3 sm:flex-row">
            <Link href="/roadmaps/freshman" className="inline-flex min-h-12 items-center justify-center rounded-lg border border-aggie-silver/25 px-5 text-sm font-bold text-white transition hover:border-aggie-steel hover:bg-white/10">
              Back to Roadmap
            </Link>
